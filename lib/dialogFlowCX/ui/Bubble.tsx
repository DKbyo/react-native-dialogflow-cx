...
> extends React.Component<BubbleProps<TMessage>> {
  ...
  get isSpecialComponent() {
    return (
      this.props.currentMessage.button ||
  ...
  renderMessageInfo() {
    ...
    const backgroundColor =
      wrapperStyle.left.backgroundColor || styles.left.wrapper;
  ...
  renderMessageAccordion() {
    const { currentMessage, wrapperStyle, textStyle, onAccordionPress } =
      this.props;
    const backgroundColor =
      wrapperStyle.left.backgroundColor || styles.left.wrapper;
    const color = textStyle.left.color;
  ...
  renderMessageButton() {
    const { currentMessage, onButtonPress, wrapperStyle, textStyle } =
      this.props;
    const backgroundColor =
      wrapperStyle.left.backgroundColor || styles.left.wrapper;
    const color = textStyle.left.color;
