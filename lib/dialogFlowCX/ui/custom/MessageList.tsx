...
export default class MessageButton extends Component<ListProps> {
  ...
  renderElement = (listElement: IListMessage, index) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => this.handlePress(listElement)}
        disabled={!listElement.event}
      >
        <Text style={[styles.title, { color }]}>{listElement.title}</Text>
