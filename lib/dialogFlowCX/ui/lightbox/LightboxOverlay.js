...
import { Animated, Dimensions, Modal, PanResponder, Platform, SafeAreaView, StatusBar, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
...
export default class LightboxOverlay extends Component {
  ...
  render() {
    ...
    return (      
      <Modal visible={isOpen} transparent={false} onRequestClose={() => this.close()}>        
        {background}
        {content}
        {header}        
      </Modal>      
